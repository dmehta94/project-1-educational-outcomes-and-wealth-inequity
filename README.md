...
The project overview should be no more than one to two paragraphs (think an abstract). To conclude this section, you can state the goal or objective of your project, for example, "The objective of this project is to _____."
